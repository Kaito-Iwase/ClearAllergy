Create one horizontal animation strip for Codex pet `kaito-clear`, state `running-right`.
...
Identity: same pet in every frame: A small calm 3D-toy/sticker hybrid mascot inspired by allergy safety and focused software work: rounded white capsule body, teal face screen, tiny leaf-check badge, soft coral accent scarf, curious helpful expression, no text or logos.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `sticker`: Polished sticker mascot with bold clean shapes, crisp outline, flat colors, and minimal highlight detail. User style notes: Clean sticker-like 3D toy, readable at 192x208, rounded compact silhouette, crisp edges, no shadows, no text..
